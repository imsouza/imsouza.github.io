...
As principais precisões para a representação binária que conhecemos, são: Precisão Simples de **32 bits**, que é a precisão que será abordada neste artigo, e Precisão Dupla de **64 bits**.
...
Sabemos que o Bias para precisão simples é *127*.
...
Neste artigo foi abordado de forma simples e prática a conversão de números no formato IEEE 754 para decimal e vice-versa, sendo esse um cálculo muito visto nos cursos de Computação e Eletrônica. Vale ressaltar que é esperado que o leitor tenha os conhecimentos básicos sobre conversão de base para um melhor aproveitamento do conteúdo.
