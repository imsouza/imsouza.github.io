...
- Semáforo Contador: o valor de um semáforo contador pode variar em um range determinado. Têm como propósito controlar o acesso a um número específico de recursos, um semáforo contador pode estar relacionado a mais de uma thread.
